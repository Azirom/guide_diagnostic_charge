...
debut: {
  question: "DIAGPLUS\nOutil d'aide au diagnostic dans votre dépôt.\n\nBonjour et bienvenue ! Cet assistant a été conçu pour vous aider à diagnostiquer rapidement des problèmes liés à la recharge de votre véhicule.",
  isEndpoint: false,
  input: false,
  options: {
    "Commencer": "q_depot" }  },
...
FIN_prevenir_gestionnaire_VI: {
  question: "Nous avons bien pris note de votre problème. \n\nAlertez votre gestionnaire de parc. Signalez que le problème concerne probablement le véhicule. Donnez lui une copie de ce compte-rendu.",
  isEndpoint: true,
  input: false,
  options: {
    "Recommencer": "debut" }  },
...
FIN_prevenir_gestionnaire_borne: {
  question: "Nous avons bien pris note de votre problème. \n\nAlertez votre gestionnaire de parc. Signalez que le problème concerne probablement la borne. Donnez lui une copie de ce compte-rendu.",
  isEndpoint: true,
  input: false,
  options: {
    "Recommencer": "debut" }  },
...
FIN_prevenir_gestionnaire_complexe: {
  question: "Nous avons bien pris note de votre problème. \n\nAlertez votre gestionnaire de parc. Signalez que le problème est complexe. Donnez lui une copie de ce compte-rendu.",
  isEndpoint: true,
  input: false,
  options: {
    "Recommencer": "debut" }  },
...
FIN_gestionnaire_flotte: {
  question: "Le cas que vous rencontrez est un problème complexe qui nécessite une analyse spécifique, hors des cas prévus dans ce guide.\n\nContactez le gestionnaire de flotte.",
  isEndpoint: true,
  input: false,
  options: {
    "Recommencer": "debut" }  },
...
tester_puissance_max: {
  question: "Tester la recharge à un moment non régulé ou forcer la puissance maximum des installations.\n\nLe temps de recharge est-il revenu à la normal?",
  isEndpoint: false,
  input: false,
  options: {
...
q_essayer_autre_cable: {
  question: "Faire un nouvel essai en utilisant un autre câble. \n\nQuelle est la couleur des LED côté camion ?",
  isEndpoint: false,
  input: false,
  options: {
...
q_essayer_autre_borne: {
  question: "Faire un nouvel essai en branchant le véhicule sur une autre borne AC. \n\nQuelle est la couleur des LED côté camion ?",
  isEndpoint: false,
  input: false,
  options: {
...
q_badge_different: {
question: "Si vous utilisez des badges, testez la charge avec un badge différent.\n\nLe problème est-il résolu?",
  isEndpoint: false,
  input: false,
  options: {
...
q_autre_vehicule: {
question: "Tester la charge sur la même borne avec un autre véhicule.\n\nLe véhicule prend-il la charge ?",
  isEndpoint: false,
  input: false,
  options: {
    "Oui": "q_reinit_borne",
